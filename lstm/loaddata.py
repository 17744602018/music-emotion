...
'''
@File    :   loaddata.py
@Time    :   2023/04/12 08:38:40
@Author  :   yiyizhang 
@Version :   1.0
@Desc    :   从之前处理的文件中汇总数据到当前data中，用来bert处理数据使用。处理后的数据两列 texts 和 label
'''
...
data_path = "/Users/yiyizhang/Desktop/music-emotion/data/text_feature_lyric.csv"
csv_header = ["text","label"]
annotation_file = "/Users/yiyizhang/Desktop/PMEmo2019/newannotations/thayer_static_annotations.csv"
...
for annotation in annotations:
    lyric_path = "/Users/yiyizhang/Desktop/PMEmo2019/clyrics/{}.lrc".format(annotation['music_id'])
